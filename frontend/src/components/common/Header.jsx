      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <div className="flex items-center flex-1 sm:flex-initial">
            <Link to={user?.role === 'student' ? '/student' : '/faculty'} className="flex items-center" onClick={closeMobileMenu}>
              <div className="h-7 w-7 sm:h-8 sm:w-8 bg-primary-500 rounded flex items-center justify-center flex-shrink-0">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-secondary-200 py-3 space-y-1">
            {/* User Info Mobile */}
            <div className="flex items-center gap-3 px-3 py-2 bg-secondary-50 rounded-lg mb-3">
              <div className="h-10 w-10 bg-secondary-200 rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <button
              onClick={handleLogout}
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-md text-sm font-medium text-secondary-600 hover:bg-secondary-100 transition-colors mt-2"
            >
